...
11. Modified May 31, 2007 (ver 2.1) by Howie Sternberg
    - Modified clicktitle() and clickmaster() function to add + or - to beginning of master title text.
    - Improved function of menu items so operate like tabs. Modified CSS classes (e.g. "menuitemactive")
      and setupmenu() clickmenu(), and clicktitle() javascript functions.
    - Added "Open/close all metadata tabs" link on top of page.
12. Modified May 21, 2008 (ver 2.2) by Howie Sternberg
	...
	<xsl:if test="/metadata/idinfo[normalize-space(.) != '']">
		<div id="md-description" class="md-color">
			...
			<div class="md-masterhide">
				...
				<xsl:call-template name="biological_taxonomy"/>
				<xsl:call-template name="biological_tool"/>
				<!-- End Biological Data Profile element -->
				<xsl:call-template name="identification_access"/>
				<!-- <xsl:call-template name="identification_spatial_domain"/> -->
				<xsl:call-template name="identification_security"/>
				<xsl:call-template name="identification_cross_reference"/>
			</div>
		</div>
	</xsl:if>
</xsl:template>
	...
	<xsl:if test="/metadata/eainfo[normalize-space(.) != ''] or /metadata/spdoinfo[normalize-space(.) != '']">
		<div id="md-structure" class="md-color">
			...
			<div class="md-masterhide">
				...
				<xsl:call-template name="data_organization_esri_geometric_network"/>
				<xsl:call-template name="data_organization_esri_topology"/>
				<xsl:call-template name="data_organization_esri_feature"/>
				...
				<xsl:call-template name="data_organization_esri_terrain"/>
				<xsl:call-template name="data_organization_esri_locator"/>
			</div>
		</div>
	</xsl:if>	
</xsl:template>
...
<xsl:template name="source">
	<xsl:if test="/metadata/dataqual/lineage[normalize-space(.) != ''] or /metadata/Esri/DataProperties/lineage/Process[normalize-space(.) != '']">
		<div id="md-source" class="md-color">
			...
			<div class="md-masterhide">
				<!-- Start Biological Data Profile element -->
				<xsl:call-template name="biological_method"/>
				<!-- End Biological Data Profile element -->
				<!-- Start Shoreline Data Profile element -->
				<xsl:call-template name="shoreline_dataqual"/>
				<!-- End Shoreline Data Profile element -->
	...
	<xsl:for-each select="/metadata/idinfo/spdom[normalize-space(.) != '']">
		...
		<div class="md-detailhide">
			...
			<div class="md-itemshow">
				...
				<xsl:call-template name="descgeog"/>
			 	<!-- ESRI Profile element -->
				<xsl:for-each select="lboundng[*[normalize-space(.) != '']]">		
					<div class="md-item">In Projected or local coordinates</div>
					<div class="md-itemhide">
						<!-- ESRI Profile element -->	
						<xsl:for-each select="/metadata/spref/horizsys/cordsysn/projcsn[normalize-space(.) != '']">
							<div class="md"><xsl:value-of select="translate(.,'_',' ')"/></div>
						</xsl:for-each>		
						<table class="md-grid">
							<tr><th>Boundary</th><th>Coordinate</th></tr>
							<!-- ESRI Profile element -->
							<xsl:for-each select="leftbc[normalize-space(.) != '']">
								<tr>
									<td>Left</td>
									<td><xsl:value-of select="."/>
										<xsl:for-each select="/metadata/spref/horizsys/planar/planci/plandu[normalize-space(.) != '']">
							...
							<!-- ESRI Profile element -->
							<xsl:for-each select="rightbc[normalize-space(.) != '']">
								<tr>
									<td>Right</td>
									<td><xsl:value-of select="."/>
										<xsl:for-each select="/metadata/spref/horizsys/planar/planci/plandu[normalize-space(.) != '']">
							...
							<!-- ESRI Profile element -->
							<xsl:for-each select="topbc[normalize-space(.) != '']">
								<tr><td>Top</td>
									<td><xsl:value-of select="."/>
										<xsl:for-each select="/metadata/spref/horizsys/planar/planci/plandu[normalize-space(.) != '']">
											<xsl:text> (</xsl:text><xsl:value-of select="."/><xsl:text>)</xsl:text>
							...
							<!-- ESRI Profile element -->
							<xsl:for-each select="bottombc[normalize-space(.) != '']">
								<tr><td>Bottom</td>
									<td><xsl:value-of select="."/>
										<xsl:for-each select="/metadata/spref/horizsys/planar/planci/plandu[normalize-space(.) != '']">
											<xsl:text> (</xsl:text><xsl:value-of select="."/><xsl:text>)</xsl:text>
				...
				<!-- Start Biological Data Profile element -->
				<xsl:call-template name="biological_boundalt"/>
				<!-- End Biological Data Profile element -->	
			</div>
...
<xsl:template name="browse_graphic">
	...
	<div class="md-detailhide">
		...
		<xsl:for-each select="/metadata/idinfo/browse[browsen[normalize-space(.) != ''] or browsed[normalize-space(.) != ''] or browset[normalize-space(.) != '']]">
			...
			<div class="md"><b>Browse graphic <xsl:number value="position()" format="1"/></b></div>
			<div class="md-indent">
				<xsl:choose>
					<xsl:when test="$typeBG = 'JPG' or $typeBG = 'JPEG' or $typeBG = 'GIF' or $typeBG = 'PNG' or $typeBG = 'BMP'">
						<div class="md">
							<xsl:for-each select="browsen[normalize-space(.) != '']">
								<span class="md-bgraphic"><xsl:attribute name="browsen"><xsl:value-of select="."/></xsl:attribute>Open</span>
							</xsl:for-each>
							<xsl:for-each select="browsed[normalize-space(.) != '']">
								<xsl:text> - </xsl:text><xsl:value-of select="."/>
							</xsl:for-each>
						</div>
						<div class="md-detailhide"><img class="md-bgraphicimg"><xsl:attribute name="src"><xsl:text>nothing</xsl:text></xsl:attribute><xsl:attribute name="alt"><xsl:text>Graphic Image</xsl:text></xsl:attribute></img></div>
					</xsl:when>
					<xsl:otherwise>
						<div class="md">
							<xsl:for-each select="browsen[normalize-space(.) != '']">			
								<a target="viewer"><xsl:attribute name="href"><xsl:value-of select="."/></xsl:attribute><xsl:text>Open</xsl:text></a>
								</xsl:for-each>
							<xsl:for-each select="browsed[normalize-space(.) != '']">		
								<xsl:text> - </xsl:text><xsl:value-of select="."/>
							</xsl:for-each>
		...
		<div class="md-detailhide">
			...
			<div class="md-itemshow">				
				<xsl:for-each select="/metadata/dataqual/lineage/procstep[normalize-space(.) != '']">
					<div class="md-itemlist">Process Step <xsl:number value="position()" format="1"/></div>
					<div class="md-itemhide">
						<!-- Start Shoreline Data Profile element -->
						...
						<xsl:if test="procdate[normalize-space(.) != '']">
							<div class="md"><b>Process date: </b><xsl:value-of select="procdate"/>
								<xsl:if test="proctime[normalize-space(.) != '']"> <b> Process time: </b><xsl:value-of select="proctime"/></xsl:if>
							</div>
						</xsl:if>
						<!-- <xsl:for-each select="procdate[normalize-space(.) != '']">
							<div class="md"><b>Process date: </b><xsl:value-of select="."/></div>
						</xsl:for-each>
						<xsl:for-each select="proctime[normalize-space(.) != '']">
							<div class="md"><b>Process time: </b><xsl:value-of select="."/></div>
						</xsl:for-each>  -->
						<!-- ESRI Profile element -->
						<xsl:for-each select="procsv[normalize-space(.) != '']">
							<div class="md"><b>Process software and version: </b><xsl:value-of select="."/></div>
						</xsl:for-each>
						<xsl:if test="srcused[normalize-space(.) != '']">
							<div class="md-itemlist">Data Source used</div>
							<div class="md-itemshow">
								<xsl:for-each select="srcused[normalize-space(.) != '']">
									<xsl:variable name="SrcCiteaUsed">
										<xsl:value-of select="."/>
									</xsl:variable>
									<xsl:choose>
										<xsl:when test="/metadata/dataqual/lineage/srcinfo/srccitea = $SrcCiteaUsed">
											<xsl:for-each select="/metadata/dataqual/lineage/srcinfo[normalize-space(.) != '']">
												<xsl:choose>
													<xsl:when test="srccitea = $SrcCiteaUsed">
														<xsl:call-template name="data_source_info"/>
													</xsl:when>
												</xsl:choose>
											</xsl:for-each>
										...
										<xsl:otherwise>
											<div class="md-indent"><b><xsl:value-of select="$SrcCiteaUsed"/></b></div>
										</xsl:otherwise>
									</xsl:choose>
								</xsl:for-each>
							</div>
						</xsl:if>
						<xsl:if test="srcprod[normalize-space(.) != '']">
							<div class="md-itemlist">Data Source produced</div>
							<div class="md-itemshow">
								<xsl:for-each select="srcprod[normalize-space(.) != '']">
									<xsl:variable name="SrcCiteaProd">
										<xsl:value-of select="."/>
									</xsl:variable>
									<xsl:choose>
										<xsl:when test="/metadata/dataqual/lineage/srcinfo/srccitea = $SrcCiteaProd">
											<xsl:for-each select="/metadata/dataqual/lineage/srcinfo[normalize-space(.) != '']">
												<xsl:choose>
													<xsl:when test="srccitea = $SrcCiteaProd">
														<xsl:call-template name="data_source_info"/>
													</xsl:when>
												</xsl:choose>
											</xsl:for-each>
										...
										<xsl:otherwise>
											<div class="md-indent"><b><xsl:value-of select="$SrcCiteaProd"/></b></div>
										</xsl:otherwise>
									</xsl:choose>
								</xsl:for-each>
							</div>
...
<xsl:template name="data_quality_esri_geoprocessing">
	...
	<xsl:if test="/metadata/Esri/DataProperties/lineage/Process[normalize-space(.) != '']">
		...
		<div class="md-detailhide">
			...
			<div class="md-itemshow">
				<!-- ESRI Profile element -->	
				<xsl:for-each select="/metadata/Esri/DataProperties/lineage/Process[normalize-space(.) != '']">
					<div class="md-item"><xsl:number value="position()" format="1"/><xsl:text> </xsl:text>
					<xsl:choose>
					...
					<div class="md-itemhide">
				 		<xsl:if test="@Date[normalize-space(.) != '']">
							<div class="md"><b>Date: </b><xsl:value-of select="@Date"/>
								<xsl:if test="@Time[normalize-space(.) != '']"> <b> Time: </b><xsl:value-of select="@Time"/></xsl:if>
							</div>
						</xsl:if>
						<xsl:if test="@ToolSource">
							<div class="md"><b>Tool location: </b><xsl:value-of select="@ToolSource"/></div>
						</xsl:if>
						<div class="md"><b>Command issued: </b><xsl:value-of select="."/></div>
					</div>
				</xsl:for-each>
			</div>
		</div>
...
<!-- ESRI Feature Type -->
<xsl:template name="data_organization_esri_feature">
	<!-- ESRI Profile element -->
	<xsl:if test="/metadata/spdoinfo/ptvctinf/esriterm[normalize-space(.) != '']">
		<div class="md-detail">
		...
		<div class="md-detailhide">
			...
			<!-- ESRI Profile element -->
				<xsl:for-each select="/metadata/spdoinfo/ptvctinf/esriterm[normalize-space(.) != '']">
					...
					<div class="md-itemhide">
						<xsl:for-each select="efeatyp[normalize-space(.) != '']">
							<div class="md"><b>ESRI feature type: </b><xsl:value-of select="."/></div>
						</xsl:for-each>
						<xsl:for-each select="efeageom[normalize-space(.) != '']">
							<div class="md"><b>Geometry type: </b><xsl:value-of select="."/></div>
						</xsl:for-each>
						<xsl:for-each select="featdesc[normalize-space(.) != '']">
							<div class="md"><b>Feature description: </b><xsl:value-of select="."/></div>
						</xsl:for-each>
						<xsl:for-each select="esritopo[normalize-space(.) != '']">
							<div class="md"><b>Topology: </b><xsl:value-of select="."/></div>
						</xsl:for-each>
						<xsl:for-each select="efeacnt[normalize-space(.) != '']">
							<div class="md"><b>Feature count: </b><xsl:value-of select="."/></div>
						</xsl:for-each>
						<xsl:for-each select="spindex[normalize-space(.) != '']">
							<div class="md"><b>Spatial index: </b><xsl:value-of select="."/></div>
						</xsl:for-each>
						<xsl:for-each select="linrefer[normalize-space(.) != '']">
							<div class="md"><b>Linear referencing: </b><xsl:value-of select="."/></div>
						</xsl:for-each>
						<xsl:for-each select="netwrole[normalize-space(.) != '']">
							<div class="md"><b>Network role: </b><xsl:value-of select="."/></div>
						</xsl:for-each>
						<xsl:for-each select="XYRank[normalize-space(.) != '']">
							<div class="md"><b>XY Rank: </b><xsl:value-of select="."/></div>
						</xsl:for-each>
						<xsl:for-each select="ZRank[normalize-space(.) != '']">
							<div class="md"><b>Z Rank: </b><xsl:value-of select="."/></div>
						</xsl:for-each>
						<xsl:for-each select="topoWeight[normalize-space(.) != '']">
							<div class="md"><b>Topology weight: </b><xsl:value-of select="."/></div>
						</xsl:for-each>
						<xsl:for-each select="validateEvents[normalize-space(.) != '']">
							<div class="md"><b>Events on validation: </b><xsl:value-of select="."/></div>
						</xsl:for-each>
						<xsl:if test="partTopoRules">
							<xsl:choose>
								<!-- ESRI Profile element -->	
								<xsl:when test="/metadata/Esri/DataProperties/topoinfo/topoRule/topoRuleID[normalize-space(.) != '']">
									<div class="md-itemlist">Participates in topology rules</div>
									<div class="md-itemshow">
										<xsl:for-each select="partTopoRules[normalize-space(.) != '']">
											<xsl:for-each select="topoRuleID[normalize-space(.) != '']">
												<xsl:variable name="TopoRuleID">
													<xsl:value-of select="."/>
												</xsl:variable>
												<xsl:choose>
													<xsl:when test="/metadata/Esri/DataProperties/topoinfo/topoRule/topoRuleID = $TopoRuleID">
														<xsl:for-each select="/metadata/Esri/DataProperties/topoinfo/topoRule[normalize-space(.) != '']">
															<xsl:choose>
																<xsl:when test="topoRuleID = $TopoRuleID">
																	<xsl:call-template name="esri_topology_info"/>
																</xsl:when>
															</xsl:choose>
														</xsl:for-each>
													</xsl:when>
								...
								<xsl:otherwise>
									<div class="md"><b>Participates in topology rules:</b></div>
									<div class="md-indent">
										<xsl:for-each select="partTopoRules[normalize-space(.) != '']">
											<xsl:variable name="countRule">
												<xsl:value-of select="position()"/>
											</xsl:variable>
											<xsl:for-each select="topoRuleID[normalize-space(.) != '']">
												<xsl:variable name="TopoRuleID2">
													<xsl:value-of select="."/>
												</xsl:variable>
												<xsl:choose>
													<xsl:when test="$countRule = 1">
														<b>Rule Id: </b><xsl:value-of select="$TopoRuleID2"/>
													</xsl:when>
													<xsl:otherwise>
														<xsl:text>, </xsl:text>
														<xsl:value-of select="$TopoRuleID2"/>
													</xsl:otherwise>
												</xsl:choose>
											</xsl:for-each>
										</xsl:for-each>
...
<xsl:template name="data_organization_esri_geometric_network">
	<!-- ESRI Profile element -->	
	<xsl:for-each select="/metadata/spdoinfo/netinfo[normalize-space(.) != '']">
		<div class="md-detail">
...
features in many feature classes in a geodatabase.</div>
			...
			<xsl:if test="connrule[normalize-space(.) != '']">
				<div class="md-itemlist">Connectivity rules</div>
				<div class="md-itemshow"> 
					<xsl:for-each select="connrule[normalize-space(.) != '']">
						<div class="md-item">
							<xsl:choose>
								<xsl:when test="ruletype[normalize-space(.) != '']">
									<xsl:value-of select="ruletype"/><xsl:text> rule</xsl:text> 
								</xsl:when>
								<xsl:otherwise>
						...
						<div class="md-itemhide">
							<xsl:for-each select="rulecat[normalize-space(.) != '']">
								<div class="md"><b>Rule category: </b><xsl:value-of select="."/></div>
							</xsl:for-each>
							<xsl:for-each select="rulehelp[normalize-space(.) != '']">
								<div class="md"><b>Rule description: </b><xsl:value-of select="."/></div>
							</xsl:for-each>
							<xsl:if test="rulefeid[normalize-space(.) != ''] or rulefest[normalize-space(.) != '']">
								<div class="md-block">
									<div class="md"><b>From edge</b></div>
									<div class="md-indent">
										<xsl:for-each select="rulefeid[normalize-space(.) != '']">
											<div class="md"><b>Feature class: </b><xsl:value-of select="."/></div>
										</xsl:for-each>	
										<xsl:for-each select="rulefest[normalize-space(.) != '']">
											<div class="md"><b>Subtype code: </b><xsl:value-of select="."/></div>
										</xsl:for-each>
									</div>	
								</div>	
							</xsl:if>
							<xsl:if test="ruleteid[normalize-space(.) != ''] or ruletest[normalize-space(.) != '']">
								<div class="md-block">
									<div class="md"><b>To edge</b></div>
									<div class="md-indent">
										<xsl:for-each select="ruleteid[normalize-space(.) != '']">
											<div class="md"><b>Feature class: </b><xsl:value-of select="."/></div>
										</xsl:for-each>	
										<xsl:for-each select="ruletest[normalize-space(.) != '']">
											<div class="md"><b>Subtype code: </b><xsl:value-of select="."/></div>
										</xsl:for-each>
									</div>	
								</div>	
							</xsl:if>
							<xsl:if test="ruleeid[normalize-space(.) != ''] or ruleest[normalize-space(.) != ''] or ruleemnc[normalize-space(.) != ''] or ruleemxc[normalize-space(.) != '']">
								<xsl:if test="ruleeid[normalize-space(.) != ''] or ruleest[normalize-space(.) != '']">
									<div class="md-block">
										<div class="md"><b>Edge</b></div>
										<div class="md-indent">
											<xsl:for-each select="ruleeid[normalize-space(.) != '']">
												<div class="md"><b>Feature class: </b><xsl:value-of select="."/></div>
											</xsl:for-each>	
											<xsl:for-each select="ruleest[normalize-space(.) != '']">
												<div class="md"><b>Subtype code: </b><xsl:value-of select="."/></div>
											</xsl:for-each>
											<xsl:if test="ruleemnc[normalize-space(.) != ''] or ruleemxc[normalize-space(.) != '']">
												<div class="md"><b>Cardinality</b></div>
												<div class="md-indent">
													<xsl:for-each select="ruleemnc[normalize-space(.) != '']">
														<div class="md"><b>Minimum: </b><xsl:value-of select="."/></div>
													</xsl:for-each>
													<xsl:for-each select="ruleemxc[normalize-space(.) != '']">
														<div class="md"><b>Maximum: </b><xsl:value-of select="."/></div>
													</xsl:for-each>
												</div>
											</xsl:if>	
										</div>	
							...
							<xsl:if test="rulejid[normalize-space(.) != ''] or rulejst[normalize-space(.) != ''] or rulejmnc[normalize-space(.) != ''] or rulejmxc[normalize-space(.) != '']">
								<xsl:if test="rulejid[normalize-space(.) != ''] or rulejst[normalize-space(.) != '']">
									<div class="md-block">
										<div class="md"><b>Junction</b></div>
										<div class="md-indent">
											<xsl:for-each select="rulejid[normalize-space(.) != '']">
												<div class="md"><b>Feature class: </b><xsl:value-of select="."/></div>
											</xsl:for-each>	
											<xsl:for-each select="rulejst[normalize-space(.) != '']">
												<div class="md"><b>Subtype code: </b><xsl:value-of select="."/></div>
											</xsl:for-each>
											<xsl:if test="rulejmnc[normalize-space(.) != ''] or rulejmxc[normalize-space(.) != '']">
												<div class="md"><b>Cardinality</b></div>
												<div class="md-indent">
													<xsl:for-each select="rulejmnc[normalize-space(.) != '']">
														<div class="md"><b>Minimum: </b><xsl:value-of select="."/></div>
													</xsl:for-each>
													<xsl:for-each select="rulejmxc[normalize-space(.) != '']">
														<div class="md"><b>Maximum: </b><xsl:value-of select="."/></div>
													</xsl:for-each>
												</div>
											</xsl:if>	
							...
							<xsl:if test="ruledjid[normalize-space(.) != ''] or ruledjst[normalize-space(.) != '']">
								<div class="md-block">
									<div class="md"><b>Default Junction</b></div>
									<div class="md-indent">
										<xsl:for-each select="ruledjid[normalize-space(.) != '']">
											<div class="md"><b>Feature class: </b><xsl:value-of select="."/></div>
										</xsl:for-each>	
										<xsl:for-each select="ruledjst[normalize-space(.) != '']">
											<div class="md"><b>Subtype code: </b><xsl:value-of select="."/></div>
										</xsl:for-each>
									</div>	
								</div>	
							</xsl:if>
							<xsl:if test="rulejunc[normalize-space(.) != '']">
								<div class="md"><b>Available junctions</b></div>
								<xsl:for-each select="rulejunc[normalize-space(.) != '']">
									<div class="md-indentblock">
										<xsl:for-each select="junctid[normalize-space(.) != '']">
											<div class="md"><b>Feature class: </b><xsl:value-of select="."/></div>
										</xsl:for-each>
										<xsl:for-each select="junctst[normalize-space(.) != '']">
											<div class="md"><b>Subtype code: </b><xsl:value-of select="."/></div>
										</xsl:for-each>										
									</div>
								</xsl:for-each>	
			...
			<xsl:if test="elemcls[normalize-space(.) != '']">
				<div class="md-itemlist">Network elements</div>
				<div class="md-itemshow">
					<xsl:for-each select="elemcls[normalize-space(.) != '']">
						<div class="md-item"><xsl:value-of select="position()"/><xsl:text>. </xsl:text>Network element</div>
							<div class="md-itemhide">
							<xsl:for-each select="roletype[normalize-space(.) != '']">
								<div class="md"><b>Ancillary role: </b><xsl:value-of select="."/></div>
							</xsl:for-each>
							<xsl:for-each select="rolefld[normalize-space(.) != '']">
								<div class="md"><b>Ancillary role attribute: </b><xsl:value-of select="."/></div>
							</xsl:for-each>
							<xsl:for-each select="enabfld[normalize-space(.) != '']">
								<div class="md"><b>Enabled attribute: </b><xsl:value-of select="."/></div>
							</xsl:for-each>
						</div>
					</xsl:for-each>
				</div>	
...
<!-- ESRI Topology Information -->					
<xsl:template name="data_organization_esri_topology">
	<!-- ESRI Profile element -->	
	<xsl:if test="/metadata/Esri/DataProperties/topoinfo[normalize-space(.) != '']">
		<div class="md-detail">
		...
		<div class="md-detailhide">
			...
			<xsl:for-each select="/metadata/Esri/DataProperties/topoinfo[normalize-space(.) != '']">
				<xsl:for-each select="topoProps[normalize-space(.) != '']">
					<xsl:for-each select="topoName[normalize-space(.) != '']">
						<div class="md"><b>Topology name: </b><xsl:value-of select="."/></div>
					</xsl:for-each>
					<xsl:for-each select="clusterTol[normalize-space(.) != '']">
						<div class="md"><b>Cluster tolerance: </b><xsl:value-of select="."/></div>
					</xsl:for-each>
					<xsl:for-each select="trustedArea/trustedPolygon[normalize-space(.) != '']">
						<div class="md"><b>Trusted area coordinates: </b><xsl:value-of select="."/></div>
					</xsl:for-each>
					<xsl:for-each select="notTrusted[normalize-space(.) != '']">
						<div class="md"><b>Nothing trusted: </b><xsl:value-of select="."/></div>
					</xsl:for-each>
					<xsl:for-each select="maxErrors[normalize-space(.) != '']">
						<div class="md"><b>Maximum error count: </b><xsl:value-of select="."/></div>
					</xsl:for-each>
				</xsl:for-each>
				<xsl:if test="topoRule[normalize-space(.) != '']">
					<div class="md-itemlist">Topology rules</div>
					<div class="md-itemshow">
						<xsl:for-each select="topoRule[normalize-space(.) != '']">
							<xsl:call-template name="esri_topology_info"/>
						</xsl:for-each>
					</div>
				</xsl:if>
...
<xsl:template name="data_source_info">
	<xsl:choose>
		...
		<xsl:otherwise>
			<div class="md-item">Data Source <xsl:number value="position()" format="1"/></div>
		</xsl:otherwise>
	</xsl:choose>
	<div class="md-itemhide">
...
<!-- ESRI topology info -->
<xsl:template name="esri_topology_info">
	<xsl:choose>
		<!-- ESRI Profile element -->
		<xsl:when test="topoRuleID[normalize-space(.) != '']">
			<xsl:choose>
				<xsl:when test="topoRuleName[. = '']">
					<xsl:for-each select="topoRuleType[normalize-space(.) != '']">
						<div class="md-item">
							<xsl:choose>
							<xsl:when test=".=-1">Any Rule Type</xsl:when>
							<xsl:when test=".=0">Line or Polygon Must Be Larger Than Cluster Tolerance</xsl:when>
							<xsl:when test=".=1">Polygon Must Not Have Gaps</xsl:when>
							<xsl:when test=".=3">Polygon Must Not Overlap</xsl:when>
							<xsl:when test=".=4">Polygon Must Be Covered By Feature Class Of</xsl:when>
							<xsl:when test=".=5">Polygon Must Cover Each Other</xsl:when>
							<xsl:when test=".=7">Polygon Must Be Covered By</xsl:when>
							<xsl:when test=".=8">Polygon Must Not Overlap With</xsl:when>
							<xsl:when test=".=10">Line Must Be Covered By Boundary Of</xsl:when>
							<xsl:when test=".=13">Point Must Be Covered By Boundary Of</xsl:when>
							<xsl:when test=".=15">Point Must Be Properly Inside Polygon</xsl:when>
							<xsl:when test=".=19">Line Must Not Overlap</xsl:when>
							<xsl:when test=".=20">Line Must Not Intersect</xsl:when>
							<xsl:when test=".=21">Line Must Not Have Dangles</xsl:when>
							<xsl:when test=".=22">Line Must Not Have Pseudonodes</xsl:when>
							<xsl:when test=".=26">Line Must Be Covered By Feature Class Of</xsl:when>
							<xsl:when test=".=28">Line Must Not Overlap With</xsl:when>
							<xsl:when test=".=29">Point Must Be Covered By Line</xsl:when>
							<xsl:when test=".=31">Point Must Be Covered By Endpoint Of</xsl:when>
							<xsl:when test=".=37">Polygon Boundary Must Be Covered By</xsl:when>
							<xsl:when test=".=38">Polygon Area Boundary Must Be Covered By Boundary Of</xsl:when>
							<xsl:when test=".=39">Line Must Not Self-Overlap</xsl:when>
							<xsl:when test=".=40">Line Must Not Self-Intersect</xsl:when>
							<xsl:when test=".=41">Line Must Not Intersect Or Touch Interior</xsl:when>
							<xsl:when test=".=42">Line Endpoint Must Be Covered By</xsl:when>
							<xsl:when test=".=43">Polygon Contains Point</xsl:when>
							<xsl:when test=".=44">Line Must Be Single Part</xsl:when>
				...
				<xsl:otherwise>
					<xsl:for-each select="topoRuleName[normalize-space(.) != '']">
						<div class="md-item"><xsl:value-of select="."/></div>
					</xsl:for-each>
				</xsl:otherwise>
			</xsl:choose>
			<!-- <div class="md-item"><xsl:value-of select="topoRule"/></div> -->
		</xsl:when>
		<xsl:otherwise>
			<div class="md-item">Rule</div>
		</xsl:otherwise>
	</xsl:choose>
	<div class="md-itemhide">
		<xsl:for-each select="topoRuleID[normalize-space(.) != '']">
			<div class="md"><b>Rule Id: </b><xsl:value-of select="."/></div>
		</xsl:for-each>		
		<xsl:for-each select="topoRuleType[normalize-space(.) != '']">
			<div class="md"><b>Rule type: </b><xsl:value-of select="."/></div>
		</xsl:for-each>		
		<xsl:for-each select="rulehelp[normalize-space(.) != '']">
			<div class="md"><b>Rule type description: </b><xsl:value-of select="."/></div>
		</xsl:for-each>			
		<xsl:if test="rulehelp[. = '']">
			<xsl:for-each select="topoRuleType[normalize-space(.) != '']">						
				<div class="md"><b>Rule type description: </b>
					<xsl:choose>
						<xsl:when test=".=-1">Used when querying.</xsl:when>
						<xsl:when test=".=0">Cluster tolerance is the minimum distance between vertices of features. Vertices that fall within the cluster tolerance are defined as coincident and are snapped together.</xsl:when>
						<xsl:when test=".=1">Polygons must not have a void between them within a feature class or subtype. Line errors are created from the outlines of void areas in a single polygon or between polygons. Polygon boundaries that are not coincident with other polygon boundaries are errors.</xsl:when>
						<xsl:when test=".=3">Polygons must not overlap within a feature class or subtype. Polygons can be disconnected or touch at a point or touch along an edge. Polygon errors are created from areas where polygons overlap.</xsl:when>
						<xsl:when test=".=4">Polygons in the first feature class or subtype must be covered by the polygons of the second feature class or subtype. Polygon errors are created from the uncovered areas of polygons in the first feature class or subtype.</xsl:when>
						<xsl:when test=".=5">All polygons in the first feature class or subtype and all polygons in the second feature class or subtype must cover each other. Polygon errors are created where any part of a polygon is not covered by one or more polygons in the other feature class or subtype.</xsl:when>
						<xsl:when test=".=7">Polygons in one feature class or subtype must be covered by a single polygon from another feature class or subtype. Polygon errors are created from polygons from the first feature class or subtype that are not covered by a single polygon from the second feature class or subtype.</xsl:when>
						<xsl:when test=".=8">Polygons of the first feature class or subtype must not overlap polygons of the second feature class or subtype. Polygon errors are created where polygons from the two feature classes or subtypes overlap.</xsl:when>
						<xsl:when test=".=10">Lines in one feature class or subtype must be covered by the boundaries of polygons in another feature class or subtype. Line errors are created on lines that are not covered by the boundaries of polygons.</xsl:when>
						<xsl:when test=".=13">Points in one feature class or subtype must touch boundaries of polygons from another feature class or subtype. Point errors are created where points do not touch the boundaries of polygons.</xsl:when>
						<xsl:when test=".=15">Points in one feature class or subtype must be inside polygons of another feature class or subtype. Point errors are created where the points are outside or touch the boundary of the polygons.</xsl:when>
						<xsl:when test=".=19">Lines must not overlap any part of another line within a feature class or subtype. Lines can touch, intersect and overlap themselves. Line errors are created where lines overlap.</xsl:when>
						<xsl:when test=".=20">Lines must not cross or overlap any part of another line within the same feature class or subtype. Line errors are created where lines overlap, and point errors are created where lines cross.</xsl:when>
						<xsl:when test=".=21">The end of a line must touch any part of one other line or any part of itself within a feature class or subtype. Point errors are created at the end of a line that does not touch at least one other line or itself.</xsl:when>
						<xsl:when test=".=22">The end of a line cannot touch the end of only one other line within a feature class or subtype. The end of a line can touch any part of itself. Point errors are created where the end of a line touches the end of only one other line.</xsl:when>
						<xsl:when test=".=26">Lines in one feature class or subtype must be covered by lines in another feature class or subtype. Line errors are created on the lines in the first feature class that are not covered by the lines in the second feature class.</xsl:when>
						<xsl:when test=".=28">Lines in one feature class or subtype must not overlap any part of another line in another feature class or subtype. Line errors are created where lines from two feature classes or subtypes overlap.</xsl:when>
						<xsl:when test=".=29">Points in one feature class or subtype must be covered by lines in another feature class or subtype. Point errors are created on the points that are not covered by lines.</xsl:when>
						<xsl:when test=".=31">Points in one feature class or subtype must be covered by the ends of lines in another feature class or subtype. Point errors are created on the points that are not covered by the ends of lines.</xsl:when>
						<xsl:when test=".=37">Polygon boundaries in one feature class or subtype must be covered by the lines of another feature class or subtype. Line errors are created where polygon boundares are not covered by a line of another feature class or subtype.</xsl:when>
						<xsl:when test=".=38">The boundaries of polygons in one feature class or subtype must be covered by the boundaries of polygons in another feature class or subtype. Line errors are created where polygon boundaries in the first feature class or subtype are not covered by the boundaries of polygons in another feature class or subtype.</xsl:when>
						<xsl:when test=".=39">Lines must not overlap themselves within a feature class or subtype. Lines can touch, intersect, and overlap lines in another feature class or subtype. Line errors are created where lines overlap themselves.</xsl:when>
						<xsl:when test=".=40">Lines must not cross or overlap themselves within a feature class or subtype. Lines can touch themselves and touch, intersect, and overlap other lines. Line errors are created where lines overlap themselves, and point errors are created where lines cross themselves.</xsl:when>
						<xsl:when test=".=41">Lines can only touch at their ends and must not overlap each other within a feature class or subtype. Lines can touch, intersect, and overlap themselves. Line errors are created where lines overlap, and point errors are created where lines cross or touch.</xsl:when>
						<xsl:when test=".=42">The ends of lines in one feature class or subtype must be covered by points in another feature class or subtype. Point errors are created at then ends of lines that are not covered by a point.</xsl:when>
						<xsl:when test=".=43">Each polygon of the first feature class or subtype must contain within its boundaries at least one point of the second feature class or subtype. Polyon errors are created from the polygons that do not contain at least one point. A point on the boundary of a polygon is not contained in that polygon.</xsl:when>
						<xsl:when test=".=44">Lines within a feature class or subtype must only have one part. Multipart line errors are created where lines have more than one part.</xsl:when>
						<xsl:otherwise>Unknown rule</xsl:otherwise>
					</xsl:choose>
				</div>				
			</xsl:for-each>
		...
		<xsl:for-each select="topoRuleOrigin[* != '']">
			<div class="md"><b>Origin</b></div>
			<div class="md-indent">
				<xsl:for-each select="fcname[normalize-space(.) != '']">
					<div class="md"><b>Feature class: </b><xsl:value-of select="."/></div>
				</xsl:for-each>
				<xsl:choose>
					<xsl:when test="(allOriginSubtypes = 'FALSE') and ((stname !='') or (stcode != ''))">
						<div class="md"><b>Subtype code and name: </b>
						<xsl:value-of select="stcode"/><xsl:if test="stname != '' and stcode != ''"> - </xsl:if>
						<xsl:value-of select="stname"/></div>
					</xsl:when>
					<xsl:otherwise>
						<xsl:for-each select="allOriginSubtypes[normalize-space(.) != '']">
							<div class="md"><b>Applies to all origin subtypes: </b><xsl:value-of select="."/></div>
						</xsl:for-each>
					</xsl:otherwise>
				</xsl:choose>
			</div>
		...
		<xsl:for-each select="topoRuleDest[* != '']">
			<div class="md"><b>Destination</b></div>
			<div class="md-indent">
				<xsl:for-each select="fcname[normalize-space(.) != '']">
					<div class="md"><b>Feature class: </b><xsl:value-of select="."/></div>
				</xsl:for-each>
				<xsl:choose>
					<xsl:when test="(allDestSubtypes = 'FALSE') and ((stname !='') or (stcode != ''))">
						<div class="md"><b>Subtype code and name: </b>
						<xsl:value-of select="stcode"/><xsl:if test="stname != '' and stcode != ''"> - </xsl:if>
						<xsl:value-of select="stname"/></div>
					</xsl:when>
					<xsl:otherwise>
						<xsl:for-each select="allDestSubtypes[normalize-space(.) != '']">
							<div class="md"><b>Applies to all destination subtypes: </b><xsl:value-of select="."/></div>
						</xsl:for-each>
					</xsl:otherwise>
				</xsl:choose>
			</div>
...
<!-- Biological Data Profile element - Bounding Altitude -->
<xsl:template name="biological_boundalt">
	<xsl:for-each select="boundalt[normalize-space(.) != '']">	
		<div class="md">Bounding altitude</div>
		<div class="md-indent">
			<xsl:for-each select="altmin[normalize-space(.) != '']">
				<div class="md"><b>Altitude minimum: </b><xsl:value-of select="."/></div>
			</xsl:for-each>
			<xsl:for-each select="altmax[normalize-space(.) != '']">
				<div class="md"><b>Altitude maximum: </b><xsl:value-of select="."/></div>
			</xsl:for-each>>
		</div>
	</xsl:for-each>
</xsl:template>	

<!-- Biological Data Profile element - ASCII file Structure -->
<xsl:template name="biological_asciistr">
	<xsl:for-each select="asciistr[normalize-space(.) != '']">
		<div class="md"><b>ASCII file structure:</b></div>
		<div class="md-indent">
			<xsl:for-each select="recdel[normalize-space(.) != '']">
				<div class="md"><b>Record delimiter: </b><xsl:value-of select="."/></div>
			</xsl:for-each>
			<xsl:for-each select="numheadl[normalize-space(.) != '']">
			...
			<xsl:for-each select="casesens[normalize-space(.) != '']">
				<div class="md"><b>Case sensetive: </b><xsl:value-of select="."/></div>
			</xsl:for-each>
			<xsl:for-each select="authent[normalize-space(.) != '']">
				<div class="md"><b>Authentication: </b><xsl:value-of select="."/></div>
			</xsl:for-each>
			<xsl:for-each select="quotech[normalize-space(.) != '']">
				<div class="md"><b>Quote character: </b><xsl:value-of select="."/></div>
			</xsl:for-each>
			<xsl:if test="datafiel[//*[normalize-space(.) != '']]">	
				<div class="md-itemlist">Data fields</div>
				<div class="md-itemshow">				
					<xsl:for-each select="datafiel[normalize-space(.) != '']">
						<xsl:if test="dfieldnm[normalize-space(.) != '']">	
							<xsl:for-each select="dfieldnm[normalize-space(.) != '']">
								<div class="md-item"><xsl:value-of select="."/></div>
							</xsl:for-each>
							<div class="md-itemhide">
								<xsl:for-each select="missingv[normalize-space(.) != '']">
									<div class="md"><b>Missing value code: </b><xsl:value-of select="."/></div>
								</xsl:for-each>
								<xsl:for-each select="dfwidthd[normalize-space(.) != '']">
									<div class="md"><b>Data field width delimiter: </b><xsl:value-of select="."/></div>
								</xsl:for-each>
								<xsl:for-each select="dfwidth[normalize-space(.) != '']">
									<div class="md"><b>Data field width: </b><xsl:value-of select="."/></div>
								</xsl:for-each>						
							</div>
						</xsl:if>
					</xsl:for-each>
...
<!-- Biological Data Profile element - Taxonomy -->
<xsl:template name="biological_taxonomy">
	<xsl:for-each select="/metadata/idinfo/taxonomy[taxongen[normalize-space(.) != ''] or keywtax[normalize-space(.) != ''] or taxonsys[normalize-space(.) != ''] or taxoncl[normalize-space(.) != '']]">
		<div class="md-detail">
		...
		<div class="md-detailhide">
			...
			<xsl:if test="keywtax[normalize-space(.) != '']">
				...
				<div class="md-indent">
					<xsl:for-each select="keywtax[normalize-space(.) != '']">
						<div class="md"><b>Taxonomic:</b></div>
						<div class="md-indent">
							<xsl:if test="taxonkey[normalize-space(.) != '']">
								<div class="md"><b>Keywords: </b>  
									<xsl:for-each select="taxonkey[normalize-space(.) != '']">	
										<xsl:value-of select="."/>
										<xsl:if test="position() != last()"><xsl:text>, </xsl:text></xsl:if>
									</xsl:for-each>
								</div>
							</xsl:if>
							<xsl:for-each select="taxonkt[normalize-space(.) != '']">
								<div class="md"><b>Keyword thesaurus: </b><xsl:value-of select="."/></div>
							</xsl:for-each>			
						</div>			
					</xsl:for-each>
			...
			<xsl:if test="taxonsys[normalize-space(.) != '']">
				<div class="md"><b>Taxonomic system:</b></div>
				<div class="md-indent">
					<xsl:for-each select="taxonsys[normalize-space(.) != '']">
						<xsl:for-each select="classsys[normalize-space(.) != '']">
							<div class="md"><b>Classification system or authority:</b></div>
							<div class="md-indent">
								<xsl:for-each select="classcit/citeinfo[normalize-space(.) != '']">
									<div class="md"><b>Classification system citation:</b></div>
									<div class="md-indent">
										<xsl:call-template name="citation_info"/>
									</div>
								</xsl:for-each>
								<xsl:for-each select="classmod[normalize-space(.) != '']">
									<div class="md"><b>Classification system modification: </b><xsl:value-of select="."/></div>
								</xsl:for-each>			
							</div>			
						</xsl:for-each>
						<xsl:for-each select="idref/citeinfo[normalize-space(.) != '']">
							<div class="md"><b>Identification reference:</b></div>
							<div class="md-indent">
								<xsl:call-template name="citation_info"/>
							</div>
						</xsl:for-each>
						<xsl:for-each select="ider/citeinfo[normalize-space(.) != '']">
							<div class="md"><b>Identifier:</b></div>
							<div class="md-indent">
								<xsl:call-template name="citation_info"/>
							</div>
						</xsl:for-each>
						<xsl:for-each select="taxonpro[normalize-space(.) != '']">
							<div class="md"><b>Taxonomic procedures: </b><xsl:value-of select="."/></div>
						</xsl:for-each>
						<xsl:for-each select="taxoncom[normalize-space(.) != '']">
							<div class="md"><b>Taxonomic completeness: </b><xsl:value-of select="."/></div>
						</xsl:for-each>
						<xsl:for-each select="vouchers[normalize-space(.) != '']">
								<div class="md"><b>Vouchers:</b></div>
								<div class="md-indent">
									<xsl:for-each select="specimen[normalize-space(.) != '']">
										<div class="md"><b>Specimen: </b><xsl:value-of select="."/></div>
									</xsl:for-each>
									<xsl:for-each select="reposit/citeinfo[normalize-space(.) != '']">
										<div class="md"><b>Repository:</b></div>
										<div class="md-indent">
											<xsl:call-template name="citation_info"/>
										</div>
									</xsl:for-each>
			...
			<xsl:for-each select="taxongen[normalize-space(.) != '']">
				<div class="md"><b>General taxonomic coverage: </b><xsl:value-of select="."/></div>
			</xsl:for-each>
			<xsl:if test="taxoncl[normalize-space(.) != '']">
				<div class="md-item">Taxonomic Classification</div>
				<div class="md-itemhide">
...
<!-- Biological Data Profile element - Taxonomic Classification-->
<xsl:template match="taxoncl">
	<xsl:choose>
		<xsl:when test="taxoncl[normalize-space(.) != '']">
			<div id="tax" class="md-item">
				<xsl:for-each select="taxonrn[normalize-space(.) != '']">
					<xsl:value-of select="."/>
				</xsl:for-each>
				<xsl:text>: </xsl:text>
				<xsl:for-each select="taxonrv[normalize-space(.) != '']">
					<xsl:value-of select="."/>
				</xsl:for-each>
			</div>
			<div class="md-itemshow">
				<xsl:for-each select="common[normalize-space(.) != '']">
					<div class="md"><b>Common name: </b><xsl:value-of select="."/></div>
				</xsl:for-each>
				<xsl:apply-templates select="taxoncl"/>
			</div>
		</xsl:when>
		<xsl:otherwise>
			...
			<xsl:for-each select="common[normalize-space(.) != '']">
				<div class="md-indent"><b>Common name: </b><xsl:value-of select="."/></div>
			</xsl:for-each>
		</xsl:otherwise>
	</xsl:choose>
</xsl:template>

<!-- Biological Data Profile element - Analytical Tool -->
<xsl:template name="biological_tool">
	<xsl:for-each select="/metadata/idinfo/tool[tooldesc[normalize-space(.) != ''] or toolacc[normalize-space(.) != ''] or toolcont[normalize-space(.) != ''] or toolcite[normalize-space(.) != '']]">
		<div class="md-detail">
		...
		<div class="md-detailhide">
			...
			<xsl:if test="toolacc[normalize-space(.) != '']">
				<div class="md"><b>Tool Access Information:</b></div>
				<div class="md-indent">
					<xsl:for-each select="toolacc[normalize-space(.) != '']">				
						<xsl:if test="onlink[normalize-space(.) != '']">				
							<div class="md">
								<b>Online linkage: </b>
								<xsl:for-each select="onlink[normalize-space(.) != '']">						
									<a target="viewer"><xsl:attribute name="href"><xsl:value-of select="."/></xsl:attribute><xsl:value-of select="."/></a>
						...
						<xsl:for-each select="toolinst[normalize-space(.) != '']">
							<div class="md"><b>Tool access instructions: </b><xsl:value-of select="."/></div>
						</xsl:for-each>
						<xsl:for-each select="toolcomp[normalize-space(.) != '']">
							<div class="md"><b>Tool computer and operating system: </b><xsl:value-of select="."/></div>
						</xsl:for-each>
					</xsl:for-each>
				</div>
			</xsl:if>
			<xsl:for-each select="toolcont/citeinfo[normalize-space(.) != '']">
				<div class="md"><b>Tool contact:</b></div>
				<div class="md-indent">
					<xsl:call-template name="citation_info"/>
				</div>
			</xsl:for-each>
			<xsl:for-each select="toolcite/citeinfo[normalize-space(.) != '']">
				<div class="md"><b>Tool citation:</b></div>
				<div class="md-indent">
					<xsl:call-template name="citation_info"/>
				</div>
			</xsl:for-each>					
...
<!-- Biological Data Profile element - Methodology -->
<xsl:template name="biological_method">
	<xsl:if test="/metadata/dataqual/lineage/method[normalize-space(.) != '']">
		<div class="md-detail">
		...
		<div class="md-detailhide">
			...
			<div class="md-itemshow">
				<xsl:for-each select="/metadata/dataqual/lineage/method[normalize-space(.) != '']">
					<xsl:call-template name="biological_method_info"/>
				</xsl:for-each>
			</div>
		</div>
	</xsl:if>
...
<!-- Biological Data Profile element - Methodology info -->
<xsl:template name="biological_method_info">
	<div class="md-item">Method <xsl:number value="position()" format="1"/></div>
	<div class="md-itemhide">
		<xsl:for-each select="methtype[normalize-space(.) != '']">
			<div class="md"><b>Methodology Type: </b><xsl:value-of select="."/></div>
		</xsl:for-each>
		<xsl:for-each select="methodid[normalize-space(.) != '']">
			<div class="md"><b>Methodology identifier:</b></div>
			<div class="md-indent">
				<xsl:if test="methkey[normalize-space(.) != '']">
					<div class="md"><b>Keywords: </b>  
						<xsl:for-each select="methkey[normalize-space(.) != '']">	
							<xsl:value-of select="."/>
							<xsl:if test="position() != last()"><xsl:text>, </xsl:text></xsl:if>
						</xsl:for-each>
					</div>
				</xsl:if>
				<xsl:for-each select="methkt[normalize-space(.) != '']">
					<div class="md"><b>Keyword thesaurus: </b><xsl:value-of select="."/></div>
				</xsl:for-each>			
			</div>			
		</xsl:for-each>
...
<!-- Biological Data Profile element - Beginning Geologic Age -->
<xsl:template match="beggeol">
	<div class="md"><b>Beginning geologic age:</b></div>
	<div class="md-indent">
		<xsl:apply-templates select="geolage"/>
	</div>
</xsl:template>

<!-- Biological Data Profile element - Ending Geologic Age -->
<xsl:template match="endgeol">
	<div class="md"><b>Ending geologic age:</b></div>
	<div class="md-indent">
		<xsl:apply-templates select="geolage"/>
	</div>
</xsl:template>

<!-- Biological Data Profile element - Geologic Age -->
<xsl:template match="geolage">
	<div class="md"><b>Geologic age:</b></div>
	<div class="md-indent">
		<xsl:for-each select="geolscal[normalize-space(.) != '']">
			<div class="md"><b>Geologic time scale: </b><xsl:value-of select="."/></div>
		</xsl:for-each>
		<xsl:for-each select="geolest[normalize-space(.) != '']">
			<div class="md"><b>Geologic age estimate: </b><xsl:value-of select="."/></div>
		</xsl:for-each>
		<xsl:for-each select="geolun[normalize-space(.) != '']">
			<div class="md"><b>Geologic age uncertainty: </b><xsl:value-of select="."/></div>
		</xsl:for-each>
		<xsl:for-each select="geolexpl[normalize-space(.) != '']">
			<div class="md"><b>Geologic age explanation: </b><xsl:value-of select="."/></div>
		</xsl:for-each>
		<xsl:for-each select="geolcit/citeinfo[normalize-space(.) != '']">
			<div class="md"><b>Geologic citation:</b></div>
			<div class="md-indent">
				<xsl:call-template name="citation_info"/>
			</div>
		</xsl:for-each>
...
<!-- Shoreline Data Profile element - Data Quality Info -->
<xsl:template name="shoreline_dataqual">
	<xsl:for-each select="/metadata/dataqual[tidinfo[normalize-space(.) != ''] or marweat[normalize-space(.) != ''] or event[normalize-space(.) != '']]">
		<div class="md-detail">
		...
		<div class="md-detailhide">
			...
			<div class="md"><b>Tidal information:</b></div>
				<div class="md-indent">
					<xsl:for-each select="tidtype[normalize-space(.) != '']">
						<div class="md"><b>Type of tide: </b><xsl:value-of select="."/></div>
					</xsl:for-each>
					<xsl:for-each select="tidtime[normalize-space(.) != '']">
						<div class="md"><b>Time of tide: </b><xsl:value-of select="."/></div>
					</xsl:for-each>
					<xsl:for-each select="tidref[normalize-space(.) != '']">
			...
			<xsl:for-each select="marweat[normalize-space(.) != '']">
				<div class="md"><b>Marine weather condition:</b></div>
				<div class="md-indent">
					<xsl:for-each select="windsp[normalize-space(.) != '']">
						<div class="md"><b>Wind speed: </b><xsl:value-of select="."/></div>
					</xsl:for-each>
					<xsl:for-each select="windir[normalize-space(.) != '']">
						<div class="md"><b>Wind direction: </b><xsl:value-of select="."/></div>
					</xsl:for-each>
					<xsl:for-each select="wavhite[normalize-space(.) != '']">
